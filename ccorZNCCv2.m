...
%a mistake was found in ccorZNCC, here corrected

%the computation from this equation is correct ony in the case when the
%template overlap all the image!

function [correlation lagv]= ccorZNCCv2(sequence, kernel)
...
numerator = conv2(sequence,rot90(kernel,2),'same')-(kernSize*sequenceMean.*kernelMean);
