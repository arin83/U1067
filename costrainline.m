function fcn = costrainline(type,xlim,ylim,option)
...
resize_threshold = 1000 * eps;
    ...
    function new_pos = constrainLineToRect(pos)
        ...
        if is_end_point_drag
            ...
            switch option
                case 2
                    new_pos=[min(new_pos(:,1)) new_pos(1,2); min(new_pos(:,1)) new_pos(2,2)];
                case 1
                    new_pos=[new_pos(1,1) min(new_pos(:,2)); new_pos(2,1) min(new_pos(:,2))];
                case 3
            end
