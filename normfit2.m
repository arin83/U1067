function [muhat, sigmahat, muci, sigmaci] = normfit2(x,alpha,censoring,freq,options)
...
%   $Revision: 2.17.4.8 $  $Date: 2008/10/31 07:39:27 $

% Illegal data return an error.

x(isnan(x))=[]; %Arin add

% in respect to original version does eliminate the NaN values from the
% computation
%
